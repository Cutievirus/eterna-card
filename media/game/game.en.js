...
undum.game.id = "vspace.glitch.me";
...
undum.game.qualities = {
    hp: new undum.NumericQuality(
        "HP", {priority:"0001", group:'stats'}
    ),
    mp: new undum.NumericQuality(
        "MP", {priority:"0001", group:'stats'}
    ),
...
undum.game.init = function(character, system) {
    character.qualities.hp = 20;
    character.qualities.mp = 20;
